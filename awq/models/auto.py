...
class AutoAWQForCausalLM:
    ...
    @classmethod
    def from_pretrained(self, model_path, trust_remote_code=True, safetensors=False, **kwargs) -> BaseAWQForCausalLM:
        ...
        return AWQ_CAUSAL_LM_MODEL_MAP[model_type].from_pretrained(
            model_path, model_type, trust_remote_code=trust_remote_code, safetensors=safetensors, **kwargs
        )

    @classmethod
    def from_quantized(self, quant_path, quant_filename, max_new_tokens=None,
                       device='balanced', trust_remote_code=True, fuse_layers=True, **kwargs) -> BaseAWQForCausalLM:
        ...
        return AWQ_CAUSAL_LM_MODEL_MAP[model_type].from_quantized(
            quant_path, model_type, quant_filename, max_new_tokens, device, trust_remote_code=trust_remote_code, fuse_layers=fuse_layers, **kwargs
        )
