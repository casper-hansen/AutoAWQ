...
- GEMV (quantized): 20% faster than GEMM for batch size 1 (not good for large context).
...
| Model Name    | Version                                     | Batch Size | Prefill/Decode Length | Prefill tokens/s | Decode tokens/s | Memory (VRAM)    |
|---------------|---------------------------------------------|------------|-----------------------|------------------|-----------------|------------------|
